...
from .models import AdminActivityLog, Order, Product, User
...
class ProductSerializer(serializers.ModelSerializer):
    class Meta:
        model = Product
        fields = ['productId', 'productName', 'description', 'category', 'unitPrice', 'stockQuantity', 'productImage', 'status', 'createdAt', 'updatedAt']
